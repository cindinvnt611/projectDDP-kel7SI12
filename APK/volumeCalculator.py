...
def volume_calculator():
    ...
    if selected == 'Hitung Volume Kubus':
        ...
        if st.button("Hitung Volume Kerucut"):
            ...
            st.success(f"Maka volume baloknya adalah {volume:.2f} ✅")
# with tab:
#         test2 = st.sidebar.selectbox("*Mari Menghitung*", ['Volume Bangun Ruang', 'Luas Permukaan Bangun Ruang', 'Luas Bangun Datar', "Keliling Bangun Datar", "Perhitungan Dasar",], index=0)
